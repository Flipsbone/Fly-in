...
def parse_map(map_file: TextIO) -> Network:
    ...
    for i, line in enumerate(map_file):
        ...
        extract_value: list[str] = clean_line.split(":")
        ...
        match extract_value[0].strip():
            ...
            case "start_hub" | "hub" | "end_hub":
                ...
                try:
                    ...
                    coords: tuple[int, int] = (validate_zone.x , validate_zone.y)
                    if coords in my_map.used_coordinates:
                        raise ValueError(f"--- line {i} --- \n"
                                         f"Parsing Error: Duplicate coordinates '{coords}'")
            ...
            case "connection":
                ...
                connections_data: list[str] = extract_value[1].strip().split(maxsplit=2)
                ...
                try:
                    ...
                    unique_key: str = f"{validate_connection.link_1}-{validate_connection.link_2}"
